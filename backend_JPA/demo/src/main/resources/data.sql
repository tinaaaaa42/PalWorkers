...
INSERT INTO tasks (task_id,title, description, create_date, due_date,type,user_id) VALUES
                                                                                ...
                                                                                (2, '市场调研', '进行市场调研以了解客户需求。', '2023-04-02', '2024-05-25','daily',1),
                                                                                (3, '员工培训', '为员工提供新产品知识培训。', '2023-04-03', '2023-04-10','weekly',1),
                                                                                (4, '库存管理', '更新库存记录并分析销售趋势。', '2023-05-01', '2023-05-15','weekly',1),
                                                                                (5, '客户支持', '处理客户反馈和投诉。', '2023-05-02', '2024-05-25','weekly',2),
                                                                                (6, '财务报告', '准备月度财务报告。', '2023-05-03', '2023-05-10','kanban',1),
                                                                                (7, '系统维护', '进行服务器维护和软件更新。', '2023-05-04', '2024-05-25','kanban',2),
                                                                                (8, '市场活动', '规划即将到来的营销活动。', '2023-05-05', '2023-05-20','kanban',1),
                                                                                (9, '产品摄影', '拍摄新产品照片用于营销。', '2023-05-06', '2024-05-25','kanban',2),
                                                                                (10, '团队会议', '安排团队会议以讨论项目进展。', '2023-05-07', '2023-05-12','kanban',1);


-- 插入团队任务数据
INSERT INTO tasks (title, description, create_date, due_date, type, team_id) VALUES
                                                                                          ('项目启动', '启动新的开发项目。', '2023-05-08', '2023-06-01', 'weekly', 1),
                                                                                          ('季度销售报告', '准备并提交季度销售报告。', '2023-05-09', '2023-06-30', 'weekly', 2),
                                                                                          ('招聘新员工', '进行新员工的招聘和面试。', '2023-05-10', '2023-05-20', 'daily',  3),
                                                                                          ('团队建设活动', '组织团队建设活动以增强团队凝聚力。', '2023-05-11', '2023-05-25', 'kanban', 1),
                                                                                          ('年度预算规划', '制定下一年度的预算计划。', '2023-05-12', '2023-06-15', 'kanban', 2);
