...
INSERT INTO tasks (task_id, title, description, create_date, due_date) VALUES
   ...
   (3, '员工培训', '为员工提供新产品知识培训。', '2023-04-03', '2023-04-10'),
   (4, '库存管理', '更新库存记录并分析销售趋势。', '2023-05-01', '2023-05-15'),
   (5, '客户支持', '处理客户反馈和投诉。', '2023-05-02', NULL),
   (6, '财务报告', '准备月度财务报告。', '2023-05-03', '2023-05-10'),
   (7, '系统维护', '进行服务器维护和软件更新。', '2023-05-04', NULL),
   (8, '市场活动', '规划即将到来的营销活动。', '2023-05-05', '2023-05-20'),
   (9, '产品摄影', '拍摄新产品照片用于营销。', '2023-05-06', NULL),
   (10, '团队会议', '安排团队会议以讨论项目进展。', '2023-05-07', '2023-05-12');
